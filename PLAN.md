...
**Local eval approach:**
- Play N games (e.g. 200) between the model and Stockfish at depth 1, 3, 5, 8
- Win/loss/draw rates per depth give a relative strength signal across model versions
- No absolute ELO here, but sufficient to answer "is v2 better than v1?"

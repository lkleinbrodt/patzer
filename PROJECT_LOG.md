...
- **2026-05-01:** Refreshed **`MODELS.md`** with a **unified leaderboard** snapshot from **`eval/evaluate.py leaderboard`** (`eval/results.db`: H2H + capped Stockfish). Top Patzer **`patzer_v3@180`** **1632 ± 12**; strongest v2 **`patzer_v2@288`** **1475 ± 9**; v1 **`patzer_v1@40`** **1203 ± 13**. Replaced stale v3 “~1750” blurb with these fitted values.
